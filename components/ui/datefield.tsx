...
function DateInput({ className, variant = 'md', focusColor, ...props }: Omit<DateInputProps, 'children'>) {
  const customStyles = focusColor ? {
    ...
    <DateInputRa
      ...
      className={composeRenderProps(className, (className) =>
        cn(
          ...
          focusColor ? 'data-focus-within:border-[var(--custom-focus-color)] data-focus-within:ring-[var(--custom-focus-color)]/30' : dateInputStyles, 
          className
        ),
      )}
      style={customStyles}
