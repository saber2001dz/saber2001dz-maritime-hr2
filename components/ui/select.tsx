  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "rtl:pr-2 rtl:pl-8 ltr:pr-8 ltr:pl-2",
        className
      )}
      {...props}
    >
      <span className="absolute flex size-3.5 items-center justify-center rtl:left-2 ltr:right-2">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4" />
        </SelectPrimitive.ItemIndicator>
      </span>
      <SelectPrimitive.ItemText className="rtl:text-right ltr:text-left">{children}</SelectPrimitive.ItemText>
    </SelectPrimitive.Item>
  )
}
