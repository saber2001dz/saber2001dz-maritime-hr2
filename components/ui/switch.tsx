...
interface CustomSwitchProps extends AriaSwitchProps {
  customColor?: string
}

const Switch = ({ children, className, customColor, ...props }: CustomSwitchProps) => (
  <AriaSwitch
      ...
      <>
        <div
          className={cn(
            ...
            /* Selected */
            customColor ? "bg-input" : "bg-input group-data-[selected]:bg-primary",
            /* Readonly */
          ...
          style={customColor ? {
            backgroundColor: props.isSelected ? customColor : undefined
          } : undefined}
        >
          <div
            className={cn(
